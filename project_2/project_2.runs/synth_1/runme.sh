...
HD_PWD='/home/jinstorm/vivado/project_2/project_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ARM_CPU_pipeline.vds -m64 -mode batch -messageDb vivado.pb -notrace -source ARM_CPU_pipeline.tcl
