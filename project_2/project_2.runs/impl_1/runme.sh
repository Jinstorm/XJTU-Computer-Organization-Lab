...
HD_PWD='/home/jinstorm/vivado/project_2/project_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ARM_CPU_pipeline.vdi -applog -m64 -messageDb vivado.pb -mode batch -source ARM_CPU_pipeline.tcl -notrace
